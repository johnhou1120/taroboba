# Generated by Django 3.2.8 on 2022-02-15 14:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duedate', models.DateTimeField(default=datetime.date(2022, 5, 16))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('options', models.TextField(blank=True, help_text='input options, separated by [,]', null=True)),
            ],
            options={
                'ordering': ['code'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enableingredients', models.ManyToManyField(blank=True, to='store.Ingredients')),
            ],
            options={
                'ordering': ['code'],
            },
